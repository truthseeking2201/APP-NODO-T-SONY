...
export function AppHeader() {
  ...
  return (
    <header
      className={`sticky top-0 z-[var(--z-sticky)] w-full pt-4 pb-4 transition-colors duration-300 border-b border-white/10 ${
      ...
      <div className="container flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <ReferralTooltip dataRefer={dataRefer}>
            <Button
              variant="link"
              className="text-white flex items-center gap-2 text !no-underline"
