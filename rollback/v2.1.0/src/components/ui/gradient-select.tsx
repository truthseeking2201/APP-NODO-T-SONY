  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          className="min-w-40 flex items-center justify-between bg-[#181818] text-white rounded-lg px-4 py-2 h-10 border border-white/20"
          type="button"
        >
          <span className="truncate text-left">{selectedNames}</span>
          <svg
