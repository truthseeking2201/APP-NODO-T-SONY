    ...
    () => [
      {
        ...
        classTitle: "text-white/80 text-left w-[290px]",
        render: (_, record: DepositVaultConfig) => <VaultItem item={record} />,
      },
      {
        title: "TVL",
        dataIndex: "tvl",
        classTitle: "text-white/80 text-left w-[160px]",
        classCell: "align-middle",
      ...
      },
      {
        title: "APY",
        dataIndex: "apy",
        classTitle: "text-white/80 text-left w-[120px]",
        classCell: "align-middle",
        keySort: "vault_apy",
        render: (value: any, record: any) => (
      ...
      },
      {
        title: "Your Holdings",
        dataIndex: "holdings",
        classTitle: "text-white/80 justify-end w-[140px]",
        classCell: "align-middle justify-end w-[140px]",
        keySort: "user_holdings",
        render: (_: any, record: any) => (
          <span className="text-white font-medium font-mono text-base">
            {record.user_holdings
              ? `$${formatAmount({
                  amount: record.user_holdings,
                  precision: 6,
                })}`
              : "$--"}
          </span>
          ...
          <GradientSelect
            options={[
              { value: "all", label: "All Chains" },
              {
                ...
                label: "SUI",
                icon: (
                  <img src="/chains/sui.png" alt="SUI" className="w-5 h-5" />
                ),
              },
              {
                value: "bsc",
                ...
                disabled: true,
                icon: (
                  <img src="/chains/bsc.png" alt="BSC" className="w-5 h-5" />
                ),
                left: (
                  <div
