...
const VaultInfo = ({ poolName }: { poolName: string }) => {
  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="font-mono text-lg text-white">{poolName}</span>
      </div>
    </div>
  );
};
...
const DepositModal = (props: DepositModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent hideIconClose className="py-8">
        <DialogHeader>
          {depositStep === 1 && (
            <>
        ...
        <DialogDescription>
          {depositStep === 1 && (
            <div className="flex flex-col gap-2 p-4 border border-white/15 rounded-xl bg-white/5">
              <VaultInfo poolName={vault?.pool?.pool_name} />
              <div className="flex items-center justify-between">
          ...
          {depositStep === 2 && (
            <div className="flex flex-col gap-2">
              ...
              <div className="font-sans text-center font-medium text-base mb-2 text-[#9CA3AF]">
        ...
        <DialogFooter>
          ...
          {depositStep === 2 && (
            <div className="w-full">
              <Web3Button onClick={onDone} className="w-full rounded-lg">
                Done
              </Web3Button>
            </div>
          )}
