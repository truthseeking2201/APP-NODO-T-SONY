...
export default function WithdrawForm({
  ...
  return (
    <div>
          ...
          >
            <RowItem.Label>
              <LabelWithTooltip
                ...
                labelClassName="text-gray-200 text-sm font-bold"
      ...
      >
        <DialogContent className="sm:max-w-[480px] bg-[#141517] border border-white/10 p-0 rounded-2xl gap-6">
          {/* Header */}
          ...
          <DialogFooter className="px-6 pb-6 w-full flex sm:space-x-0">
            <Button
              variant="outline"
              size="lg"
              className="font-semibold !text-lg px-2 h-13 mr-4 !rounded-lg w-[120px] bg-white/5"
            ...
            <Web3Button
              className="flex-1 font-semibold text-lg py-3 rounded-lg	flex items-center justify-center"
              onClick={onWithdraw}
              disabled={isLoading}
            >
