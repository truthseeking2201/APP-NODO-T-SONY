...
const VaultDetail = () => {
  ...
  const isDetailLoading = isLoadingVaultDetails;
  ...
  if (!vaultDetails && !isDetailLoading) {
    return <Navigate to="/" replace />;
  }

  const tokens = vaultDetails?.pool?.pool_name?.split("-") || [];
  const exchange = EXCHANGE_CODES_MAP[vaultDetails?.exchange_id] || {
    code: "",
    name: "",
  };
    ...
    <PageContainer backgroundImage={DetailsBackground} className="py-6">
      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1">
          ...
          <div className="mt-6" />
          <VaultActivities isDetailLoading={isDetailLoading} />
